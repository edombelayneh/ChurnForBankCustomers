...
knn_model = load_model('knm_model.pkl')
voting_classifier_model = load_model('voting_clf_hard.pkl')
xgboost_SMOTE_model = load_model('xgboost-smote.pkl')
xgboost_feature_engineering_model = load_model('xgboost-featureEngineered.pkl')
...
def explain_prediction(probability, input_dict, surname):
  ...
  interpreting and explaining predictions of machine learning models.
    ...
    Here are the machine learning model's top 10 most important features for predicting churn:
      ...
      Dont mention the probability of churning, or the machine learning model, or say anything like 'Based on the machine learning model's prediction and the top 10 most important features', just explain the prediction.
  '''
...
def generate_email(probability, input_dict, explanation, surname):
  ...
  Make sure to list out a set of incentives to stay based on their information, in bullet point format. Dont ever mention the probability of churning, or the machine learning model to the customer.
  '''
...
if selected_customer_option:
  ...
  print('Customer ID', selected_customer_id)

  selected_customer_surname = selected_customer_option.split(" - ")[1]
  print('Surname', selected_customer_surname)
